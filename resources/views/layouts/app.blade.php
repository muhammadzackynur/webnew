...
<head>
    ...
    {{-- Bootstrap CSS (WAJIB ADA UNTUK MODAL) --}}
    ...
    <style>
        ...
        .photo-group-title.title-before { border-left-color: #EF4444 !important; }
        .photo-group-title.title-progress { border-left-color: #F59E0B !important; }
        .photo-group-title.title-after { border-left-color: #10B981 !important; }
    </style>
...
<body>
    ...
    {{-- Bootstrap JS (WAJIB ADA UNTUK MODAL) --}}
